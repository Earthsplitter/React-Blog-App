    ...
    render() {
        ...
        return (
            <form style={{display: "flex", flexWrap: "wrap"}} onSubmit={this.handleSubmit}>
                <InputBar item="firstName" value={this.state.firstName} handleInput={this.handleInput}>First
                    Name: </InputBar>
                <InputBar item="lastName" value={this.state.lastName} handleInput={this.handleInput}>Last
                    Name: </InputBar>
                ...
                <InputBar item="github" value={this.state.contactMethod.github} handleInput={this.handleInput}><span
                    className="fa fa-github"/>GitHub: </InputBar>
                <InputBar item="linkedin" value={this.state.contactMethod.linkedin} handleInput={this.handleInput}><span
                    className="fa fa-linkedin"/>LinkedIn: </InputBar>
                <InputBar item="email" value={this.state.contactMethod.email} handleInput={this.handleInput}><span
                    className="fa fa-envelope"/>Email: </InputBar>
                <InputBar item="phone" value={this.state.contactMethod.phone} handleInput={this.handleInput}><span
                    className="fa fa-phone"/>Phone: </InputBar>
